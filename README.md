...
<p align="center">Your business AI agent. Strategy, finance, market analysis frameworks.</p>

<p align="center">
  <a href="#quick-start">Quick Start</a> ·
  <a href="#features">Features</a> ·
  <a href="#the-fleet">The Fleet</a> ·
  <a href="https://github.com/Lucineer/businesslog-ai/issues">Issues</a>
</p>

---

**Live:** [businesslog-ai](https://businesslog-ai.casey-digennaro.workers.dev) · **Powered by [Capitaine](https://github.com/Lucineer/capitaine) · [Cocapn](https://github.com/Lucineer/cocapn)**

The repo IS the agent. businesslog-ai is a cocapn vessel — a self-improving repository that runs on Cloudflare Workers, thinks with LLMs, and coordinates with the fleet through git.

## Quick Start

```bash
# Fork and deploy
gh repo fork Lucineer/businesslog-ai --clone
cd businesslog-ai
npx wrangler login
...
businesslog-ai is one of 40+ autonomous vessels in the Lucineer fleet. Each vessel is a different domain of one intelligence.
